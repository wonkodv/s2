...
class GUI:
    def __init__(self, config):
        ...
        self.map_widget = c.create_image(-2200, -2000, anchor="nw", image=self.map_image.photoimage)
        self.player_widget = c.create_line(100,100,150,150,arrow=tkinter.LAST, fill=COLORS['PLAYER'], width=5)
